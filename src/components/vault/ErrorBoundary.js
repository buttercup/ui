    ...
    render() {
        ...
        return (
            <ErrorCallout intent={Intent.DANGER} icon="heart-broken" title="Error">
                <p>
                    A fatal error has occurred - we're sorry this happened. Please check out the
                    details below in case they help diagnose the issue:
                </p>
                <code>
                    <PreForm>{this.state.error.toString()}</PreForm>
                </code>
                <If condition={this.state.errorStack}>
                    <code>
